...
<head>
    ...
    <style>
        ...
        .signup-section {
            ...
            padding: 2rem 0; /* Add padding for smaller screens where height > 100vh */
        }
        ...
        .login-card {
            ...
            padding: 3rem;
            width: 100%;
            max-width: 500px; /* Slightly wider than login for side-by-side inputs */
...
<body>
                ...
                <div class="col-12 d-flex justify-content-center align-items-center">
                    ...
                    <div class="login-card">
                        ...
                        <form>
                            ...
                            <div class="form-floating mb-3 position-relative">
                                <input type="password" class="form-control" id="confirmPassword" placeholder="Confirm Password" style="padding-right: 45px;">
                            ...
                            <div class="d-flex align-items-start mb-4">
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" id="termsCheck" style="background-color: var(--input-bg); border-color: #555;">
                            ...
                            <button type="submit" class="btn btn-gold mb-3">Sign Up</button>
                        </form>
                        ...
                        <div class="text-center mt-4">
                            <p class="text small mb-0">
                                ...
                                <a href="PowerWatch_Login.html" class="text-gold fw-bold ms-2">Sign In</a>
                            </p>
                        </div>
                    </div>
    ...
    <!-- Generic Password Toggle Script -->
    <script>
